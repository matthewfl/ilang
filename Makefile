...
SRCS= parserTree.cc import.cc parser.cc variable.cc scope.cc object.cc database.cc error.cc print.cc init.cc thread.cc function.cc value.cc identifier.cc
